...
const Landingpage = () => {
  ...
  return (
    <>
      <div className="container pt-24 pb-4 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
          <h1 className="my-4 text-3xl md:text-5xl text-white opacity-75 font-bold leading-tight text-center md:text-left">
            Vtech
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-gray-500 to-purple-500">
            Renewable
            </span><br/>
             services!  
          </h1>
          ...
          <form className="bg-gray-800 opacity-75 w-full shadow-lg rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="flex items-center justify-between pt-4">
              <button
                className="bg-gradient-to-r from-purple-500 to-green-800 hover:from-gray-500 hover:to-green-700 text-white font-bold py-2 px-4 rounded focus:ring transform transition hover:scale-80  ease-in-out"
                type="button"
              >
               Contact Us
              </button>
