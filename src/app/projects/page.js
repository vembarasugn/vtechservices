                            ...
                            <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                                ...
                                <div className="relative z-10 bg-white rounded shadow p-6 w-10/12 -mb-20">
                                    <div className="flex items-center justify-between w-full sm:w-full mb-8">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-6">
                                                ...
                                                <p className="text-gray-500 text-sm tracking-normal font-normal leading-5">Avg Sales</p>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="flex items-center pl-3 text-teal-400">
                                    ...
                                    <div className="relative mb-3">
                                        ...
                                        <hr className="absolute top-0 h-1 w-7/12 rounded-sm bg-teal-500" />
                                    </div>
                            ...
                            <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                                ...
                                <div className="relative z-10 p-4 bg-white shadow rounded mx-auto w-9/12 -mb-20">
                                    ...
                                    <div className="mt-4 flex items-center">
                                        ...
                                        <p className="ml-1 text-sm text-gray-500 leading-3 tracking-normal font-normal">Specter Consultancy</p>
                                    </div>
                                    <div className="mt-3 flex items-center">
                                        ...
                                        <p className="ml-1 text-sm text-gray-500 leading-3 tracking-normal font-normal">2,354 USD</p>
                                    </div>
                                    <button className="relative focus:outline-none mt-4 py-2 pr-10 bg-teal-500 text-white tracking-normal text-xs pl-3 cursor-pointer hover:opacity-90">
                                        View Invoice
                            ...
                            <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                                ...
                                <div className="relative z-10 bg-white rounded shadow p-6 w-10/12 -mb-20">
                                    <div className="flex items-center justify-between w-full sm:w-full mb-8">
                                        <div className="flex items-center">
                                            <div className="p-4 bg-yellow-200 rounded">
                                                <svg xmlns="/Electricals2.jpg" className="icon icon-tabler icon-tabler-discount" width={32} height={32} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" />
                                                    <line x1={9} y1={15} x2={15} y2={9} />
                                                    <circle cx="9.5" cy="9.5" r=".5" />
                                                    <circle cx="14.5" cy="14.5" r=".5" />
